...
export type BingxActivePosition = {
  currency: string
  positionAmt: string
  availableAmt: string
  positionSide: string
...
export type UserPositionResponse = GenericResponse<BingxActivePosition[]>
...
export type KLineResponse = GenericResponse<KLineData[]>
